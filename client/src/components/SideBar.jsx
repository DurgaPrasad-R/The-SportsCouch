...
const SideBar = () => {
  return (
    <div className="side-bar flex flex-col gap-5 w-full max-w-72 h-screen bg-white pt-7 my-1">
      <Link to={"/user/options/create-team"}>
